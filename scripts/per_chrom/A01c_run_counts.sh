#!/bin/bash
#$ -cwd
#$ -o logs/A01c_varcon_counts.$JOB_ID.$TASK_ID
#$ -j y
...
VARCON=/u/project/cluo/terencew/demux_benchmark/programs/for_nadia/50line_chrom/per_chrom/A01c_varcon_counts.sh
